...
function homePage() {
  ...
  <section class="section section--cream"><div class="shell">
    ...
    <div class="card-grid">
      <article class="image-card reveal" style="background-image:url('assets/scene-health.svg')"><div class="image-card__content"><p class="kicker">LIVE EXPERIENCE</p><h3>Innovation in action</h3><p>See treatments, technologies and launches presented by specialists.</p></div></article>
      <article class="image-card reveal" style="background-image:url('assets/scene-beauty.svg')"><div class="image-card__content"><p class="kicker">BUSINESS</p><h3>Connections that matter</h3><p>Meet brands, clinics, partners and decision-makers from across markets.</p></div></article>
      <article class="image-card reveal" style="background-image:url('assets/scene-wellness.svg')"><div class="image-card__content"><p class="kicker">PERSONAL DISCOVERY</p><h3>Care for body and mind</h3><p>Explore aesthetics, skincare, preventive care and holistic wellness.</p></div></article>
    </div>
  </div></section>
...
function parisPage() {
  return `${pageHero("Paris 2027.", "A new city. The same international ambition. Health & Beauty Expo Paris is coming soon.", `<a class="button button--white" href="#updates">Keep me updated ${icons.arrow}</a>`, "assets/scene-beauty.svg")}

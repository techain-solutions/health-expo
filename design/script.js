...
function participantInfoPage() {
  ...
  <section class="section section--soft"><div class="shell"><div class="section-heading"><div><p class="kicker">DOCUMENTS</p><h2>Downloads for participating companies.</h2></div><p>These documents remain subject to organiser and legal validation before public production publication.</p></div><div class="download-grid"><article class="download-card"><span>↧</span><b>Participant manual 2026</b><small>Rules, logistics, payment and safety</small><a href="downloads/participant-manual-2026.pdf" target="_blank">Download NL PDF</a><a href="downloads/participant-manual-2026-en.pdf" target="_blank">Download EN PDF</a></article><article class="download-card"><span>↧</span><b>Exhibitor agreement</b><small>Dutch agreement template</small><a href="downloads/exhibitor-agreement-nl.pdf" target="_blank">Open PDF</a></article><article class="download-card"><span>↧</span><b>Stand price list</b><small>Stand and sponsorship packages</small><a href="downloads/stand-pricing-2026.pdf" target="_blank">Download PDF</a></article><article class="download-card"><span>↧</span><b>Expo floor plan</b><small>Static hall layout</small><a href="downloads/expo-floor-plan.pdf" target="_blank">Open PDF</a></article></div></div></section>
...
function contactPage() {
  ...
  <section class="section section--soft"><div class="shell"><div class="section-heading"><div><p class="kicker">FIND US</p><h2>De Broodfabriek, Rijswijk.</h2></div><a class="button button--outline" href="https://maps.google.com/?q=${mapQuery}" target="_blank" rel="noopener">Open in Google Maps ${icons.external}</a></div><div class="map-card reveal"><div class="map-card__pin" aria-hidden="true">⌖</div><div class="map-card__body"><b>De Broodfabriek</b><span>Volmerlaan 12, 2288 GD Rijswijk</span><span>The Netherlands</span></div><a class="map-card__link" href="https://maps.google.com/?q=${mapQuery}" target="_blank" rel="noopener">View directions ${icons.arrow}</a></div></div></section>

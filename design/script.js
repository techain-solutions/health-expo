...
function homePage() {
  ...
  <section class="section section--dark"><div class="shell split">
    <div class="split-copy reveal"><p class="kicker">FAIR MATCH</p><h2 style="color:white">A personal introduction, coordinated by our team.</h2><p style="color:rgba(255,255,255,.65)">Share what you are looking for and our organizing team will follow up personally with the appropriate next step.</p><a class="button button--white" href="?page=fair-match">How Fair Match works ${icons.arrow}</a></div>
    <ol class="timeline reveal"><li><span>01</span><div><h3 style="color:white">Share your interest</h3><p style="color:rgba(255,255,255,.58)">Tell us what kind of connection would be useful.</p></div></li><li><span>02</span><div><h3 style="color:white">We review your request</h3><p style="color:rgba(255,255,255,.58)">The organizing team reviews the details personally.</p></div></li><li><span>03</span><div><h3 style="color:white">Receive a personal follow-up</h3><p style="color:rgba(255,255,255,.58)">Our team contacts you with the appropriate next step.</p></div></li></ol>
  </div></section>
...
function fairMatchPage() {
  const fields = `<div class="form-row">${formField("First name", "text", "Your first name")}${formField("Last name", "text", "Your last name")}</div><div class="form-row">${formField("Email", "email", "name@example.com")}${formField("Phone", "tel", "+31 …")}</div>${formField("I am interested in", "select", "Select an area", "<option>Health and medical tourism</option><option>Beauty and aesthetics</option><option>Wellness and preventive care</option><option>Business or partnership opportunities</option>")}${formField("What are you looking for?", "textarea", "Share a short note so the organizing team can follow up personally.")}`;
  return `${pageHero("Fair Match—personal introductions made simple.", "Tell us what you are looking for and the organizing team will follow up personally with the appropriate next step.", `<a class="button button--white" href="#request">Make a request ${icons.arrow}</a>`)}
  <section class="section"><div class="shell"><div class="section-heading section-heading--center"><p class="kicker">HOW IT WORKS</p><h2>A clear, personal request.</h2><p>Fair Match is an introduction request handled manually by the organizing team. It does not provide automated matching, booking, availability, chat or calendar synchronisation.</p></div><div class="card-grid"><article class="info-card"><span class="info-card__number">01</span><h3>Tell us your interest</h3><p>Share the area, opportunity or kind of introduction you are looking for.</p></article><article class="info-card"><span class="info-card__number">02</span><h3>We review your request</h3><p>The organizing team reviews the details and determines an appropriate next step.</p></article><article class="info-card info-card--teal"><span class="info-card__number">03</span><h3>Receive a personal follow-up</h3><p>The team contacts you directly after reviewing your request.</p></article></div></div></section>
  <section class="section section--soft" id="request"><div class="shell form-shell"><div class="form-intro"><p class="kicker">INTRODUCTION REQUEST</p><h2>How can we help connect you?</h2><p>Complete the static preview to demonstrate the intended visitor experience.</p><div class="contact-card"><b>Personal follow-up</b><span>Your request is sent to the organizing team for manual offline follow-up.</span></div></div>${staticForm("Your request", fields, "Send request")}</div></section>`;
}

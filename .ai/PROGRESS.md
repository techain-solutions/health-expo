...
## Current State
- Project gate: `READY_FOR_CODEX`
- Active feature: `F-000 - Runnable Project Foundation`
- Active feature status: `READY`
- Last confirmed event: Client accepted the final custom Next.js offer and the project was declared launched.
- Current blocker: None for F-000. Product features remain locked. A disclosed legacy WordPress credential must be rotated before any migration access.

## Feature Status
| ID | Feature | Status | Dependencies | Test Result |
|---|---|---|---|---|
| F-000 | Runnable Project Foundation | READY | None | Not run |
| F-001 | Multilingual Public Shell and RTL | PLANNED | F-000 PASSED | Locked |
| F-002 | Staff Authentication and RBAC | PLANNED | F-000 PASSED | Locked |
| F-003 | Rijswijk Event Management and Publication | PLANNED | F-002 PASSED | Locked |
| F-004 | Exhibitor Management and Public Directory | PLANNED | F-001, F-002 PASSED | Locked |
| F-005 | Public Core Pages and External Ticket Journey | PLANNED | F-001, F-003, F-004 PASSED | Locked |
| F-006 | Media Upload and Management | PLANNED | F-002, F-003 PASSED | Locked |
| F-007 | Static Floor-Plan Management and Display | PLANNED | F-002, F-005, F-006 PASSED | Locked |
| F-008 | Contact, Participation, and Accreditation Requests | PLANNED | F-001, F-002, F-005 PASSED | Locked |
| F-009 | Fair Match Manual Request Workflow | PLANNED | F-002, F-004, F-008 PASSED | Locked |
| F-010 | Media/Press and Legal/Informational Pages | PLANNED | F-001, F-002, F-008 PASSED | Locked |
| F-011 | Content Migration and Five-Language Integration | PLANNED | F-005..F-010 PASSED | Locked |
| F-012 | SEO, Accessibility, Performance, Security Hardening | PLANNED | F-011 PASSED | Locked |
| F-013 | Deployment, Domain, SSL, Launch Verification | PLANNED | F-012 PASSED | Locked |
...
## Current Work
- F-000 is ready for Codex implementation.
- No application code or tests have been created or executed by this planning package.

## Awaiting Verification
- None. Codex has not implemented F-000 yet.
...
- Later features: approve database, auth, media storage, email, hosting/region, retention, and role details.

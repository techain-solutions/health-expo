...
export type Database = {
  public: {
    Tables: {
      ...
      exhibitors: { Row:{id:string;name:string;slug:string;category:string;description:string;website_url:string|null;image_path:string|null;image_content_type:string|null;is_active:boolean;is_featured:boolean;display_order:number;created_at:string;updated_at:string}; Insert:Partial<{name:string;slug:string;category:string;description:string;website_url:string|null;image_path:string|null;image_content_type:string|null;is_active:boolean;is_featured:boolean;display_order:number}>; Update:Partial<{name:string;slug:string;category:string;description:string;website_url:string|null;image_path:string|null;image_content_type:string|null;is_active:boolean;is_featured:boolean;display_order:number}>; Relationships: []; };
